...
function selectRuntimesFromArgs(runtimeArgs) {
  if (runtimeArgs.includes('--all')) {
    return ['claude', 'kimi', 'kimi-code', 'kilo', 'kiro', 'opencode', 'pi', 'codex', 'copilot', 'antigravity', 'cursor', 'windsurf', 'augment', 'trae', 'qwen', 'hermes', 'codebuddy', 'cline', 'zcode'];
  }
  ...
  if (runtimeArgs.includes('--kiro')) selected.push('kiro');
...
const banner = '\n' +
  ...
  '  development workflows for Claude Code, OpenCode, Kimi CLI, Kilo, Kiro, Codex, Copilot, Antigravity, Cursor, Windsurf, Augment, Trae, Qwen Code, Hermes Agent, Cline, CodeBuddy, ZCode and pi.\n';
...
const allRuntimes = ['claude', 'antigravity', 'augment', 'cline', 'codebuddy', 'codex', 'copilot', 'cursor', 'hermes', 'kimi', 'kimi-code', 'kilo', 'kiro', 'opencode', 'pi', 'qwen', 'trae', 'windsurf', 'zcode'];
...
function buildRuntimePromptText() {
  ...
  ${cyan}13${reset}) Kiro         ${dim}(~/.kiro)${reset}
