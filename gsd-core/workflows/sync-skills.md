...
# Parse --to
if [[ "$@" == *"--to all"* ]]; then
  TO_RUNTIMES=(antigravity augment claude cline codebuddy codex copilot cursor grok hermes kilo kimi kimi-code kiro opencode pi qwen trae windsurf zcode)
elif [[ "$@" == *"--to"* ]]; then
